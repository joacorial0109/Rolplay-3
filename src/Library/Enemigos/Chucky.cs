...
{
    /// <summary>
    /// Chucky es un enemigo que puede atacar con un cuchillo.
    /// </summary>
    public class Chucky : Enemy
    {
        /// <summary>
        ...
        public override int AttackValue
        {
            get
            {
                if (Knife == null) return 0 + 5;
                return Knife.AttackValue + 5;
            }
        }
        ...
        /// 
        public Chucky(string name) : base(name)
        {
            this.MaxHealth = 100;
